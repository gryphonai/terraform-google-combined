...
* [API documentation](https://cloud.google.com/dialogflow/docs/reference/rest/v2/projects/environment)
* How-to Guides
...
* `voice` -
  ...
  Structure is [documented below](#nested_text_to_speech_settings_synthesize_speech_configs_synthesize_speech_config_voice).


<a name="nested_text_to_speech_settings_synthesize_speech_configs_synthesize_speech_config_voice"></a>The `voice` block supports:
